...
namespace CallCenter_DAL.SMSFloat.Debit.Archived
{
  public class ArchivedTransactionSMSDebit : IDBModel
  {
    ...
    public int? Bulk_SMS_ID { get; set; }

    public int? Bulk_SMS { get; set; }
